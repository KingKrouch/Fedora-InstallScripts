...
wget -O i2c.conf https://github.com/KingKrouch/Fedora-KDE-InstallScripts/raw/main/etc/modules-load.d/i2c.conf && sudo mv i2c.conf /etc/modules-load.d && sudo dnf install https://openrgb.org/releases/release_0.7/openrgb_0.7_x86_64_6128731.rpm -y
